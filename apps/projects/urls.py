...
from .views import MarkTaskCompleteView, ProjectCreateView, ProjectDeleteView, ProjectsListView, ProjectDetailView, ProjectUpdateView, TaskCreateView, TaskUpdateView, TaskDeleteView
...
urlpatterns = [
    ...
    path('task/<slug:slug>/<int:year>/<int:month>/<int:day>/mark_complete/', MarkTaskCompleteView.as_view(), name='mark_complete'),
